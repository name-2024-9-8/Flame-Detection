...
Flask主应用入口 (融合模式 — 数据源为人员B的PHP API)
...
def health_check():
    ...
    try:
        import requests
        php_status = 'ok'
        resp = requests.get('http://localhost:8080/index.php/api/statistics/health', timeout=5)
    ...
    return {
        ...
        'fusion_mode': True,
        'php_api': php_status,
        'php_api_base': app.config.get('PHP_API_BASE', 'http://localhost:8080/index.php/api'),
    }
...
if __name__ == '__main__':
    ...
    print("  PHP API地址: {}".format(app.config.get('PHP_API_BASE', 'http://localhost:8080/index.php/api')))
