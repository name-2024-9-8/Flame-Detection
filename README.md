...
### 登录页面
![登录页面](docs/images/01_登录页面.png)

### 报警审核页
![报警审核页](docs/images/08_报警审核页.png)

### 摄像头管理
![摄像头管理](docs/images/06_摄像头管理.png)

### 云盒设备管理
![云盒设备管理](docs/images/07_云盒设备管理.png)

### 系统配置
![系统配置](docs/images/09_系统配置页.png)

### 用户管理
![用户管理](docs/images/10_用户管理页.png)

### 故障管理
![摄像头故障](docs/images/11_故障摄像头.png)
![云盒故障](docs/images/17_故障云盒.png)

### 日志审计
![访问日志](docs/images/14_访问日志.png)
![操作日志](docs/images/13_操作日志.png)
...
![数据库ER图](docs/images/diagram_数据库ER图.png)
